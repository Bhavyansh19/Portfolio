      ...
      content: [
        {
          icon: "🏋️",
          label: "Fitness",
          details: "Strength training & running",
        },
        { icon: "🎮", label: "Gaming", details: "Strategy & RPG games" },
        {
          icon: "⚽",
          label: "Football",
          details: "Playing & watching matches",
        },
      ...
      <div ref={slider} className="flex h-screen w-[300vw]">
                ...
                style={{
                  ...
                  background: `radial-gradient(circle, ${
                    Object.values(categoryColors)[
                      Math.floor(
                        Math.random() * Object.values(categoryColors).length
                      )
                    ]
                ...
                <div className="relative mb-6">
                  <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-xl">
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white text-4xl font-bold">
                      <img src="https://res.cloudinary.com/dyptshrbj/image/upload/v1765898899/bj1.jpg" />
                    </div>
                  </div>
                  <motion.div
        ...
        <div className="panel flex flex-col items-center justify-center w-screen h-screen p-12 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center w-full text-white">
            <AnimatedTitle
              title="Skill<b>v<b/>erse"
              containerClass="text-6xl font-bold mb-8"
            />
            ...
            <div className="relative w-full overflow-hidden mb-12">
              ...
              >
                {[...logosSet1, ...logosSet1].map((logo, index) =>
                  renderLogo(logo, index, "top")
                )}
              </motion.div>
            </div>
            ...
            <div className="relative w-full overflow-hidden">
              <motion.div
                ...
                style={{ width: "calc(200% + 100px)" }}
              >
                {[...logosSet2, ...logosSet2].map((logo, index) =>
                  renderLogo(logo, index, "bottom")
                )}
              </motion.div>
            </div>
          </div>

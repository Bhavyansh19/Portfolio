    ...
    <div id="contact" className="my-20 min-h-96 w-screen px-10">
      <div className="relative rounded-lg bg-[#ff813b] py-24 text-blue-50 sm:overflow-hidden opacity-95">
        <div className="flex flex-col items-center text-center text-yellow-300">
          ...
          <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center z-10 opacity-5">
          ...
          <div className="flex space-x-4 mt-10">
            <Button
              ...
              onClick={() =>
                (window.location.href = "mailto:bhavyansh.bj@gmail.com")
              }
            />
            <Button
              title="View CV"
              ...
              onClick={() =>
                window.open(
                  "https://drive.google.com/drive/folders/1sNmDOx7nzfpZWEjBL5Vsggd4rLfYdL4y?usp=drive_link",
                  "_blank"
                )
              }
            />
